...
public class ShopWeaponItem : MonoBehaviour {
    ...
    void Awake() {
        ...
        name_label = transform.Find("v1").GetComponent<UILabel>();
        effect_label = transform.Find("v2").GetComponent<UILabel>();
        pricesell_label = transform.Find("v3").GetComponent<UILabel>();
    }
